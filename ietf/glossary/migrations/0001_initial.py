    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introduction', models.CharField(blank=True, help_text='The page introduction text. You can only use 511 characters.', max_length=511)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_links', to='glossary.GlossaryPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
